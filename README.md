# VBA-tools
A collection of functions to add functionality to Excel, interface VBA with R, or improve the readability and debugging in VBA. Download VBA-All.xlsm for improved readability.
